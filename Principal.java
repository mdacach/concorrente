...
public class Principal {
    ...
    private static JPanel starterPanel;
    private static JButton howButton;

    private static String howMessage = "We are interested in if (or when) a system percolates.\n" +
